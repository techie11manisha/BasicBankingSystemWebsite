    ...
    <body>
        ...
        <div class="container-fluid" style="overflow: hidden; padding: 1vw; background-color: #d4418e; background-image: linear-gradient(315deg, #d4418e 0%, #0652c5 74%);">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner" style="height: 30vw;">
                <div class="carousel-item active">
                  <img src="images/transaction1.jpg" class="d-block w-100" alt="..." style="height: 30vw">
                </div>
                <div class="carousel-item">
                  <img src="images/transaction2.jpg" class="d-block w-100" alt="..." style=" height: 30vw;">
                </div>
                <div class="carousel-item">
                  <img src="images/transaction3.jpg" class="d-block w-100" alt="..." style=" height: 30vw;">
                </div>
              </div>
            ...
            <div class = "customer-div">
              <center><p class="table_caption">Transactions' Details</p></center>
              <?php
                    ...
                    if($result = mysqli_query($link, 'SELECT * FROM `transaction`'))
                    {
                        if(mysqli_num_rows($result) > 0)
                        {
                            echo '<table>';
                                echo '<th class = "table-content">Transaction Id</th>';
                                echo '<th class = "table-content">Sender Id</th>';
                                echo '<th class = "table-content">Sender Name</th>';
                                echo '<th class = "table-content">Receiver Id</th>';
                                echo '<th class = "table-content">Receiver Name</th>';
                                echo '<th class = "table-content">Amount</th>';
                                echo '<th class = "table-content">Date & Time</th>';
                                echo "</tr>";
                            while($row = mysqli_fetch_array($result))
                            {
                                echo "<tr>";
                                    ...
                                    echo '<th class = "table-content">', $row['6'], '</th>';
                                echo "</tr>";
                            }
                            echo "</table>";
            ...
            <div style="float: right; margin-top: 5vw; padding: 2vw; border: 0.2vw solid white; border-radius: 20%; width: fit-content; margin-right: 1vw;">
              ...
              <p><img src="images/customers.png" style="width: 10vw; height: 8vw; margin-left: 3vw; animation-name: spin3D; animation-duration: 3s; animation-iteration-count: infinite; animation-timing-function: linear;"></p>
